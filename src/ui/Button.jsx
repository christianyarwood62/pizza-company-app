...
function Button({ children, disabled, to, type, onClick }) {
  ...
  // if the onClick prop is specified in Button, then create an onClick event
  if (onClick)
    return (
  ...
  /* if no 'to' prop or onclick prop is specified, return a normal button/ the disabled={displayed} just
  means that if disabled is provided in Button, then the disabled prop in the button will be true */
  return (
